(function (e) {
    ...
    0: function (e, t, a) {
        ...
        var n = {"./en.json": "edd4", "./zh-chs.json": "2e32", "./zh-cht.json": "e862", "./vi.json": "e999"};
        ...
        var n = function () {
            ...
            var e = this, t = e.$createElement, a = e._self._c || t;
            return a("footer", {staticClass: "footer"}, [a("div", {staticClass: "columns is-mobile is-centered"}, [a("div", {staticClass: "field is-grouped is-grouped-multiline"}, [a("div", {staticClass: "control"}, [a("div", {staticClass: "tags has-addons"}, [a("a", {
                staticClass: "tag is-dark",
                attrs: {href: "https://github.com/Aicirou/goindex-theme-acrou"}
            }, [e._v("goindex-theme-acrou")]), a("span", {staticClass: "tag is-light"}, [e._v(" MIT "), a("span", {staticClass: "icon"}, [a("i", {staticClass: "fa fa-github"})])])])])])])])
        }], o = {
        ...
        e.exports = JSON.parse('{"_name":"Tiếng Việt","languages":"Ngôn ngữ","index":"Trang chủ","folder":"Thư mục","notify":{"title":"Thông báo"},"copy":{"text":"Sao chép","success":"Sao chép thành công","error":"Sao chép thất bại"},"list":{"view":{"gridMode":"Chế độ lưới","listMode":"Chế độ danh sách"},"auth":"Thư mục được mã hóa, vui lòng nhập mật khẩu","title":{"file":"Tệp","moditime":"Thời gian chỉnh sửa","size":"Kích thước","operation":"Hành động"},"loading":"Đang tải...","opt":{"copy":"Sao chép liên kết","newTab":"Mở trong tab mới","download":"Tải xuống"},"total":"Tổng cộng","item":"mục"},"search":{"placeholder":"Tìm kiếm..."},"page":{"video":{"play":"Phát","download":"Tải xuống","link":"Liên kết tải xuống"},"text":{"loading":"Đang tải..."}},"setting":{"clear":{"text":"Xóa bộ nhớ đệm","success":"Xóa bộ nhớ đệm thành công"}},"checkVersion":{"tips":"Phát hiện phiên bản mới, <a href=\'${url}\'>Đi tới GitHub</a>"},"error":{"401":"Chưa được ủy quyền, vui lòng đăng nhập","shortcut_not_down":"Lối tắt không thể mở/tải xuống"}}')
    },  f3f7: function (e, t, a) {
        "use strict";
        var n = function () {
            var e = this, t = e.$createElement, a = e._self._c || t;
